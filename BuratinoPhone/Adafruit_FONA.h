...
class Adafruit_FONA : public FONAStreamType {
 public:
  ...
  boolean getBatt(char *buff, uint16_t maxlen);
  ...
  // SMS event
  boolean getEventSMS(char *i);

  // SIM phone book
  boolean getSIMSender(uint8_t i, char *sender, int senderlen);
  boolean getSIMSendernName(uint8_t i, char *sendername, int senderlen);
